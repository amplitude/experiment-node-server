...
import { ConsoleLogger, LoggerProvider } from '../util/logger';
...
export type RemoteEvaluationConfig = {
  /**
   * @deprecated use {@link this.logLevel}
   * Set to true to log some extra information to the console.
   * When set to true, it overrides LogLevel to Debug.
   */
  debug?: boolean;

  /**
   * Set the base log level output for the ExperimentClient. Defaults to LogLevel.Error
   */
  logLevel?: LogLevel;

  /**
   * Configures a logger for warnings and errors generated by the SDK. The logger can be any object that
   * conforms to the LoggerProvider interface.
   */
